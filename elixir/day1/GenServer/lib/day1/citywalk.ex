defmodule Day1.Citywalk do
  ...
  defmodule State do
    defstruct x: 0, y: 0, direction: :north, visited_points: []
  end
  ...
  defp update_state(%{x: x, y: y, visited_points: visited_points} = state, new_direction) do
    state
    |> Map.put(:direction, new_direction)
    |> Map.put(:visited_points, [[x,y] | visited_points])
  end
